import { z } from "zod";
import { createStudent, getStudentGrades, listStudents, updateStudent } from "../services/student-service.js";
...
export async function listStudentsController(_request, response) {
...
export async function getOwnGradesController(request, response) {
...
export async function getStudentGradesController(request, response) {
